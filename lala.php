...
<body>
    ...
    <h2 style="color: blueviolet;">Classificação de Triângulo</h2>
    <br>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($lado1 + $lado2 > $lado3 && $lado1 + $lado3 > $lado2 && $lado2 + $lado3 > $lado1) {
            ...
            echo "<p>Os lados descritos $lado1, $lado2 e $lado3 formam um triângulo $classificacao.</p>";
        } else {
            echo "<p>Os lados fornecidos estão inválidos.</p>";
        }
    }
    ?>
</body>
